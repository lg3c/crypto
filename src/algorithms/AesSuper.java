...
public abstract class AesSuper {

	protected static int Nb, Nk, Nr;
	...
	protected static byte[] encryptBlock(byte[] in) {
	...
	protected static byte[] decryptBlock(byte[] in) {
		byte[] tmp = new byte[in.length];
	...
	protected static byte FFMul(byte a, byte b) {
	...
	protected static byte[] deletePadding(byte[] input) {
		int count = 0;
